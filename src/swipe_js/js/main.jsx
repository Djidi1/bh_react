...
export default class SwipeToDelete extends React.Component {
    ...
    render() {
        ...
        return React.createElement(
            ...
            [
                <div key="delete" className="js-delete"
                     ref={el => this.regionDelete = el}>{this.props.background}</div>,
                <div key="content" className="js-content"
                     ref={el => this.regionContent = el}>{this.props.children}</div>
            ]
        );
    }
